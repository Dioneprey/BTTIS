...
const NavBar = props => {
    ...
    return (
        <nav onScroll={changeNavBg} className={`w-full z-50 fixed flex ease-in-out duration-200 ${navBg ? 'py-2 bg-secondary' : 'py-10 '} md:px-20 xl:px-64 px-5 items-center justify-between text-white`}>
            <div className="flex" >
            ...
            <div className="flex">
                <ul className="list-none flex items-center flex-">
                    <li className="xs:block hidden"><i class="fa-brands fa-instagram"></i></li>
                    <li className="xs:block hidden"><i class="fa-brands fa-linkedin-in"></i></li>
